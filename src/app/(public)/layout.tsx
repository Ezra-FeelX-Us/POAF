...
export default function PublicLayout({
 ...
 <MobileMenu />
      ...
      <div className="hidden lg:flex gap-6 font-semibold text-xs xl:text-sm items-center">
        ...
        <Link href="/competition" className="text-amber-400 hover:text-amber-300 font-bold transition-colors">Competition</Link>
 ...
 <Link href="/admin/dashboard" className="px-3.5 py-2 bg-slate-800 rounded-xl hover:bg-slate-700 transition-colors text-xs font-bold border border-slate-700 text-slate-300">
 Admin
 </Link>
 </div>
 </div>
