    ...
    <div className="lg:hidden flex items-center">
      ...
      {isOpen && (
        <div className="absolute top-full left-0 right-0 bg-slate-900 border-t border-slate-800 shadow-xl py-4 px-6 flex flex-col gap-3.5 text-sm font-semibold z-50">
          ...
          <Link href="/members" onClick={() => setIsOpen(false)} className="hover:text-blue-400 transition-colors">Members</Link>
          <Link href="/leadership" onClick={() => setIsOpen(false)} className="hover:text-blue-400 transition-colors">Leadership</Link>
          <Link href="/nations" onClick={() => setIsOpen(false)} className="hover:text-blue-400 transition-colors">Nations</Link>
